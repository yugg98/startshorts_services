  ...
  return (
    <div>
      ...
      <div className="pt-20 px-20">
        ...
        <p>
          Welcome to <b>Startshorts</b> (“Company”, “we”, “our”, “us”)!
        </p>
        <p>
          These Terms of Service (“Terms”, “Terms of Service”) govern your use
          of our website located at <b>Startshorts.com</b> (together or
          individually “Service”) operated by <b>Startshorts</b>.
        </p>
        <p>
        ...
        <p>
          ...
          <b>yugg9826@gmail.com</b> so we can try to find a solution. These
        ...
        <p>
          ...
          Startshorts or used with permission. You may not distribute, modify,
        ...
        <p>
          ...
          property of Startshorts and its licensors. Service is protected by
          ...
          without the prior written consent of Startshorts.
        </p>
        <p>
        ...
        <p>
          ...
          to yugg9826@gmail.com, with the subject line: “Copyright Infringement”
        ...
        <p>
          You can contact our Copyright Agent via email at yugg9826@gmail.com.
        </p>
        <p>
          13. <b>Error Reporting and Feedback</b>
        </p>
        <p>
          You may provide us either directly at yugg9826@gmail.com or via third
        ...
        <p>
          ...
          that are not owned or controlled by Startshorts.
        </p>
        <p>
          Startshorts has no control over, and assumes no responsibility for the
